<template>
  <BreadCrumb2 pageName="Terms & Condition" />
  ...
  <section class="sbp-30">
    ...
    >
      ...
      <ol class="stp-15 flex list-inside list-decimal flex-col gap-8">
        <li class="marker:heading-4">
          <span class="heading-4">Introduction</span>
          <ul
        ...
        <li class="marker:heading-4">
          <span class="heading-4">User Agreement</span>
          <ul
            class="block list-inside list-disc pt-3 text-lg text-n300 marker:text-[10px] marker:text-n900"
          >
            <li>
              You must be at least 18 years old and legally capable of entering
              into contracts to use our services. By using our services, you
        ...
        <li class="marker:heading-4">
          <span class="heading-4">Service Description</span>
          <ul
            class="block list-inside list-disc pt-3 text-lg text-n300 marker:text-[10px] marker:text-n900"
          >
            <li>
              Our website provides a platform for users to On Demand Services.
              We do not provide the services ourselves but facilitate
              connections between users and service providers.
            </li>
          </ul>
        </li>
        <li class="marker:heading-4">
          <span class="heading-4">Payment Terms</span>
          <ul
            class="block list-inside list-disc pt-3 text-lg text-n300 marker:text-[10px] marker:text-n900"
          >
            <li>
              Payment for services must be made through our platform. We may use
              third-party payment processors, and you agree to abide by their
              terms and conditions.
            </li>
            <li class="pt-3">
              Fees for services are determined by service providers and may
              vary. We are not responsible for disputes over payment or service
              quality.
            </li>
          </ul>
        </li>
        <li class="marker:heading-4">
          <span class="heading-4">User Responsibilities</span>
          <ul
            class="block list-inside list-disc pt-3 text-lg text-n300 marker:text-[10px] marker:text-n900"
          >
            <li>
              Users are responsible for their interactions with service
              providers. We do not endorse or guarantee the quality of services
              provided by service providers.
            </li>
            <li class="pt-3">
              Users agree to treat service providers with respect and to use our
              platform for lawful purposes only.
            </li>
            <li class="pt-3">
              Our website and services, including content, logos, and
              trademarks, are protected by intellectual property laws. Users may
        ...
        <li class="marker:heading-4">
          <span class="heading-4">Privacy Policy</span>
          <ul
            class="block list-inside list-disc pt-3 text-lg text-n300 marker:text-[10px] marker:text-n900"
          >
            <li>
        ...
        <li class="marker:heading-4">
          <span class="heading-4">Limitation of Liability</span>
          <ul
            class="block list-inside list-disc pt-3 text-lg text-n300 marker:text-[10px] marker:text-n900"
          >
            <li>
            ...
            <li class="pt-3">
              ...
              our services and are not responsible for any harm or loss
        ...
        <li class="marker:heading-4">
          <span class="heading-4">Changes to Terms</span>
          <ul
            class="block list-inside list-disc pt-3 text-lg text-n300 marker:text-[10px] marker:text-n900"
          >
            <li>
